...
export const metadata = {
  ...
  description: 'Turn your server into a venue pillar. Provide critical infrastructure services for 250 million-capacity venue. Service fee structure: packet delivery, PoT validation, transaction processing, performance bonding.',
};
